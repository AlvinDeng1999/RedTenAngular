...
using RedTenAngular.Authorization;
using RedTenAngular.Helpers;
using System;
using System.Collections.Generic;
using AppPermissions = DAL.Core.ApplicationPermissions;

namespace RedTenAngular
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("RedTenAngular")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.DocumentTitle = "Swagger UI - RedTenAngular";
